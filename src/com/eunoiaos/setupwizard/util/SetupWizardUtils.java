...
package com.eunoiaos.setupwizard.util;
...
import static com.eunoiaos.setupwizard.SetupWizardApp.DISABLE_NAV_KEYS;
import static com.eunoiaos.setupwizard.SetupWizardApp.ENABLE_RECOVERY_UPDATE;
import static com.eunoiaos.setupwizard.SetupWizardApp.KEY_SEND_METRICS;
import static com.eunoiaos.setupwizard.SetupWizardApp.LOGV;
import static com.eunoiaos.setupwizard.SetupWizardApp.NAVIGATION_OPTION_KEY;
import static com.eunoiaos.setupwizard.SetupWizardApp.UPDATE_RECOVERY_PROP;
...
import com.eunoiaos.setupwizard.BaseSetupWizardActivity;
import com.eunoiaos.setupwizard.BiometricActivity;
import com.eunoiaos.setupwizard.BluetoothSetupActivity;
import com.eunoiaos.setupwizard.NetworkSetupActivity;
import com.eunoiaos.setupwizard.ScreenLockActivity;
import com.eunoiaos.setupwizard.SetupWizardApp;
import com.eunoiaos.setupwizard.SimMissingActivity;
...
public class SetupWizardUtils {
    ...
    private static final String UPDATER_PACKAGE = "com.eunoiaos.updater";
    ...
    private static void handleEnableMetrics(Context context) {
        ...
        if (privacyData != null
            ...
            EunoiaSettings.Secure.putInt(context.getContentResolver(),
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        final boolean virtualKeysEnabled = EunoiaSettings.System.getIntForUser(
                context.getContentResolver(), EunoiaSettings.System.FORCE_SHOW_NAVBAR, 0,
                UserHandle.USER_CURRENT) != 0;
        if (enabled != virtualKeysEnabled) {
            EunoiaSettings.System.putIntForUser(context.getContentResolver(),
                    EunoiaSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0,
                    UserHandle.USER_CURRENT);
        }
    }
