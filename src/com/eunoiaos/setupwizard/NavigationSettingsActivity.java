...
import static com.eunoiaos.internal.util.DeviceKeysConstants.KEY_MASK_APP_SWITCH;
...
public class NavigationSettingsActivity extends BaseSetupWizardActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsTaskbarEnabled = EunoiaSettings.System.getInt(getContentResolver(),
                EunoiaSettings.System.ENABLE_TASKBAR, isLargeScreen(this) ? 1 : 0) == 1;

        int deviceKeys = getResources().getInteger(
                com.eunoiaos.platform.internal.R.integer.config_deviceHardwareKeys);
    ...
    protected void onNextPressed() {
        ...
        if (!mIsTaskbarEnabled) {
            ...
            EunoiaSettings.System.putIntForUser(getContentResolver(),
                    EunoiaSettings.System.NAVIGATION_BAR_HINT, hideHint ? 0 : 1,
